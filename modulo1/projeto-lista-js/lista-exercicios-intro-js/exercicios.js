...
function checaRenovacaoRG() {
  // implemente sua lógica aqui
  const anoEmQueVoceEsta = prompt('Em que ano você está?')
  const anoDoNascimento = prompt('Em que ano você nasceu?')
  const anoRg= prompt('Qual o ano do seu RG ?')
  const descobrindoIdade = anoEmQueVoceEsta - anoDoNascimento
